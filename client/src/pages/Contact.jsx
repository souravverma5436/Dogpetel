      ...
      try {
        await emailjs.send(
          ...
          EMAILJS_CONFIG.appointmentTemplateId,
          {
            ...
            age:             appointmentForm.age || 'Not specified',
            service:         appointmentForm.service,
            price_per_day:   `₹${appointmentForm.price_per_day}`,
            checkin_date:    appointmentForm.booking_date,
            checkin_time:    appointmentForm.time_slot,
            ...
            message:         'New appointment booking received (backend offline)',
          },
          EMAILJS_CONFIG.publicKey
        )
        setMessage({
